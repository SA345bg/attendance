<?php 
    ...
    class crud{
        ...
        public function insertAttendees($fname, $lname, $dob, $specialty, $email, $contact,$avatar_path) {
            try {
                ...
                $sql = "INSERT INTO attendee(firstname, lastname, dateofbirth, specialty_id, emailaddress, contactnumber, avatar_path) VALUES (:fname, :lname, :dob, :specialty, :email, :contact, :avatar_path)";
                // stmt = statement
